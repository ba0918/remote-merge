...
- **Completed:** 2026-03-14
- **Status:** 🟢 Complete
- **Plan:** [Link](./cycles/20260314183104_auto-badge-scan-on-server-switch.md)
- **Summary:** サーバ切替・再接続後にバッジが `[?]` のまま残る問題を修正。`restore_tree_state()` 完了後に展開済みディレクトリ＋ルート直下を自動スキャン。変更2ファイル、+5テスト、2コミット。
